...
def coba2():
    ...
    print("Assalamualaikum "+str(nama))
...
hasil = Penambahan(100, 7)
print(hasil)

#Soal no.6
from folderfahmi import kalkulator
...
#Soal no.7
from folderfahmi.bunga import bunga
...
#3.4 Ketrampilan Penanganan Error
#Jawaban No. 1
def test(nama):
    try:
        print("Assalamualaikum "+str(nama))
